...
export const useProtocolFilters = () => {
  ...
  const FILTERS = useMemo(() => {
    const protocols = getProtocolsWithIcon(appChainId)
    console.log('protocols: ', protocols)
    Object.entries(protocols).map(([protocolName, icon])=> {
      return [protocolName, {active: true, protocolName, icon}]
    })
    return protocols
    ...
    //     return [name, { active: true, name, icon }]
    //   }),
    // ) as FilterData
  }, [appChainId])
  ...
  //   console.log('[useProtocolFilters] setfilter for protocol: ', filterName)
  //   setFilters((filters) => {
